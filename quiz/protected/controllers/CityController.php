...
class CityController extends Controller 
{
	...
	public function actionIndex($pageNum=0) 
	{
		...
		if (isset($_POST['CityList'])) {
			...
			if (isset($session['criteria_c05']) && !empty($session['criteria_c05'])) {
				$criteria = $session['criteria_c05'];
	...
	public function actionSave()
	{
		if (isset($_POST['CityForm'])) {
			...
			if ($model->validate()) {
				...
				$this->redirect(Yii::app()->createUrl('city/edit',array('index'=>$model->code)));
			} else {
...
*/
	...
	public static function allowReadWrite() {
		return Yii::app()->user->validRWFunction('C05');
	}
	
	public static function allowReadOnly() {
		return Yii::app()->user->validFunction('C05');
	}
}
